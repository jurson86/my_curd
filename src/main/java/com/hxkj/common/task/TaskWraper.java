 ...
 */
public class TaskWraper implements ITask {
    private int id;                //taskBaseId
    private int taskTargetType;    //任务类型
    private String taskTargetValue;    //任务值

    public TaskWraper(int taskTargetType, String taskTargetValue) {
        this.taskTargetType = taskTargetType;
        this.taskTargetValue = taskTargetValue;
    }

    public TaskWraper(int id, int taskTargetType, String taskTargetValue) {
        this.id = id;
        this.taskTargetType = taskTargetType;
        this.taskTargetValue = taskTargetValue;
    }
