        ...
        <table id="dg" class="easyui-datagrid"  url="${ctx!}/sysNoticeType/query"
            ...
            <thead>
                <tr>
                    ...
                    <th field="typeCode" width="200">编码</th>
    ...
    <div data-options="region:'center' " split="true" title="已关联角色"   collapsed="false"  headerCls="borderTopNone">
        <table id="dg2" class="easyui-datagrid"
            ...
            <tr>
                ...
                <th field="typeName" width="200">类型名</th>
                <th field="typeCode" width="200">类型编码</th>
                <th field="roleName" width="200">角色名</th>
                <th field="roleCode" width="200">角色编码</th>
                <th field="sysRoleId" width="200" formatter="deleteFmt">操作</th>
            </tr>
            </thead>
        </table>
        <div id="tb2">
            ...
            <span id="searchSpan2" class="searchInputArea">
                ...
                <input id="sysNoticeTypeId" name="search_EQ_a.sysNoticeTypeId" type="hidden" >
                <a href="#" class="easyui-linkbutton searchBtn" data-options="iconCls:'iconfont icon-search',plain:true"
...
<script>
    function deleteFmt(val,row){
        return '<a href="javascript:delSingleNTR(\''+row.sysNoticeTypeId+'\',\''+row.sysRoleId+'\')">删除</a>'
    }
</script>
</@layout>
