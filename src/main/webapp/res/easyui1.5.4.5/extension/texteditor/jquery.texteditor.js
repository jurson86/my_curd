			...
			'insertlink': {
				...
				onClick: function(){
					var content = 
							...
							'</div>' +
							'<div style="margin-bottom:20px">' +
							'<input class="easyui-combobox link-target" label="打开方式:" labelAlign="right" panelHeight="auto" data-options="editable:false,data:[{value:\'\',text:\'当前Tab\'},{value:\'_blank\',text:\'新Tab\'}]" style="width:100%">' +
							'</div>' +
							'</div>';
					var te = $(this).texteditor('getEditor');
					var dlg = te.texteditor('getInsertDialog', {
